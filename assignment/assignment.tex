...
\begin{itemize}[leftmargin=1.2em, itemsep=4pt]
    \item \textbf{Teams}: 2-3 students per team
    \item \textbf{Duration}: 6-8 weeks (start early!)
    \item \textbf{Checkpoint 1} (Week 3): Implementation outline + preliminary results
    \item \textbf{Checkpoint 2} (Week 6): Working code + initial experiments
    \item \textbf{Final} (Week 8): Full submission + presentation
\end{itemize}
\end{tcolorbox}
